...
describe('util', () => {
    ...
    test('intNumberFromHexString', () => {
        expect((0, util_1.intNumberFromHexString)((0, _1.HexString)('0x1fffffffffffff'))).toEqual(9007199254740991);
    });
    test('hexStringFromIntNumber', () => {
        expect((0, util_1.hexStringFromIntNumber)((0, _1.IntNumber)(1234))).toEqual('0x4d2');
        expect((0, util_1.hexStringFromIntNumber)((0, _1.IntNumber)(112341234234))).toEqual('0x1a280f323a');
    });
    test('has0xPrefix', () => {

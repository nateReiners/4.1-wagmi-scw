...
const WLRelayAdapter_1 = require("./WLRelayAdapter");
...
const testStorage = new ScopedLocalStorage_1.ScopedLocalStorage('walletlink', testWalletLinkUrl);
const createAdapter = (options) => {
    const adapter = new WLRelayAdapter_1.WLRelayAdapter({
        appName: 'test',
        appLogoUrl: null,
...
//# sourceMappingURL=WLRelayAdapter.test.js.map
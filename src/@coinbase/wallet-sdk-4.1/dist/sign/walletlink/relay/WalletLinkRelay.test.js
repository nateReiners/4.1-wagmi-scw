...
const WalletLinkCipher_1 = require("./connection/WalletLinkCipher");
...
describe('WalletLinkRelay', () => {
    const options = {
        ...
        storage: new ScopedLocalStorage_1.ScopedLocalStorage('walletlink', 'test'),
    };
    beforeEach(() => {
        jest.clearAllMocks();
    ...
    describe('setSessionConfigListener', () => {
        it('should update metadata with setSessionConfigListener', async () => {
            ...
            expect(metadataUpdatedSpy).toHaveBeenCalledWith(constants_1.WALLET_USER_NAME_KEY, await decryptMock(sessionConfig.metadata.WalletUsername));
        });

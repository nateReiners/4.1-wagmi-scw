...
describe('PopupManager', () => {
    ...
    it('should open a popup with correct settings and focus it', () => {
        ...
        const popup = (0, web_1.openPopup)(url);
    ...
    it('should throw an error if popup fails to open', () => {
        ...
        expect(() => (0, web_1.openPopup)(new URL('https://example.com'))).toThrow(error_1.standardErrors.rpc.internal('Pop up window failed to open'));
    });
    it('should close an open popup window', () => {
        const mockPopup = { close: jest.fn(), closed: false };
        (0, web_1.closePopup)(mockPopup);

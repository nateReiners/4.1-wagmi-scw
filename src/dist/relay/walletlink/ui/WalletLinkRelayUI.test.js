...
const WalletLinkRelayUI_1 = require("./WalletLinkRelayUI");
describe('WalletLinkRelayUI', () => {
    const walletSDKUI = new WalletLinkRelayUI_1.WalletLinkRelayUI({
        darkMode: false,
        version: '1.2.1',
    ...
    test('@showConnecting: isUnlinkedErrorState - false', () => {
        const snackbarMock = jest
            .spyOn(Snackbar_1.Snackbar.prototype, 'presentItem')
            .mockImplementation(() => () => { });
    ...
    test('@showConnecting: isUnlinkedErrorState - true', () => {
        const snackbarMock = jest.spyOn(Snackbar_1.Snackbar.prototype, 'presentItem');
        const onResetConnection = () => { };
        const onCancel = () => { };
        walletSDKUI.showConnecting({

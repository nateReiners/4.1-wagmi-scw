...
describe('aes256gcm', () => {
    test('encrypt/decrypt', async () => {
        ...
        const cipher = new Cipher_1.Cipher(randSecret);
    ...
    test('errors', async () => {
        ...
        const differentCipher = new Cipher_1.Cipher(secret);

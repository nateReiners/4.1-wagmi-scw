...
const SignHandler_1 = require("./SignHandler");
...
describe('SignerConfigurator', () => {
    function createSignHandler() {
        return new SignHandler_1.SignHandler({
    ...
    describe('handshake', () => {
        ...
        it('should throw error if signer selection failed', async () => {
            ...
            await expect(handler.request({})).rejects.toThrow('Signer is not initialized');
        });
...
//# sourceMappingURL=SignHandler.test.js.map